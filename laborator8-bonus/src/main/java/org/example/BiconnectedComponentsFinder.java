    ...
    private void dfs(int u, int parent) {
        ...
        for (int v : graph.get(u)) {
            ...
            if (discovery[v] == 0) {
                ...
                if ((parent == -1 && children > 1) || (parent != -1 && low[v] >= discovery[u])) {
...
public class BiconnectedComponentsFinder {
    ...
    private void iterativeDfs(int start, int parent) {
        Stack<DfsFrame> dfsStack = new Stack<>();
        dfsStack.push(new DfsFrame(start, parent, false));
        ...
        while (!dfsStack.isEmpty()) {
            ...
            if (!frame.processed) {
                ...
                // Second time visiting (after children are processed)
                dfsStack.pop();
